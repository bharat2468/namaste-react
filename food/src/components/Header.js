...
const Header = () => {
    return (
        <div className="drawer relative text-primary-content">
...
const CartIcon = () => {
    const num = useSelector(selectCartQuantity);

    return (
        <div className=" avatar indicator">
            <span className="indicator-item badge badge-secondary">{num}</span>
            <svg
                xmlns="http://www.w3.org/2000/svg"
